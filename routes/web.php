...
// for CENSUS routes
    ...
    // Route::get('villages',[App\Http\Controllers\Admin\VillageController::class, 'villages']);
    // Route::get('villages', 'App\Http\Controllers\Admin\VillageController@index');
    // Route::get('villages', [VillageController::class, 'index'])->name('villages');

    // Route::resource('villages', 'Admin\VillageController')->name('villages');
    // Route::post('villages_mass_destroy', ['uses' => 'Admin\VillageController@massDestroy', 'as' => 'villages.mass_destroy']);
